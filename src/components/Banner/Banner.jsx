...
const Banner = () => {
  ...
  return (
    <div className="bg-base-200">
      <div className="md:flex text-center md:text-left w-[90%] lg:w-full mx-auto pt-20">
        <div className="md:w-[50%] flex justify-center items-center mb-10 md:mb-0">
          <div className="md:w-[80%]">
            ...
            <p className="my-5 text-[#333333]">
              ...
              Travigo, the ultimate haven for travel enthusiasts. Immerse
              yourself in a vibrant community that shares your wanderlust, where
              breathtaking landscapes, cultural experiences, and thrilling
              adventures await. Whether you're a seasoned globetrotter or an
              aspiring explorer, Travigo is your gateway to limitless
              inspiration, expert insights, and the camaraderie of fellow
              adventurers. Join us today and let your wanderlust thrive with
              Travigo, where every moment becomes an extraordinary travel tale.
            </p>
